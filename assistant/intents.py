VALID_INTENTS = {
    ...
    "save_memory_result_as_reminder",
    "show_memory_result",
...
INTENT_PATTERNS = {
    ...
    "apply_focus_duration_backfill": [
        "apply focus duration backfill",
        "backfill focus durations",
        "repair focus durations",
    ],
    "weekly_focus_stats": [
        "weekly focus stats",
    ...
    "work_session_plan": [
        "work session plan",
        "show work plan",
        "plan my work session",
        "what should i work on",
        "what is my work plan",
    ],
    "start_planned_work_session": [
        "start planned work session",
        "start work plan",
        "begin work plan",
        "start my planned work",
    ],
    "work_session_review": [
        "work session review",
        "review work session",
    ...
    "start_recommended_work_session": [
        ...
        "begin recommended work session",
...
INTENT_PREFIXES = {
    ...
    "keep_memory_result": [
        "keep memory result ",
        "keep only memory result ",
    ],
    "remove_memory_result": [
        "remove memory result ",
        "delete memory result ",
    ],
    "preview_delete_memory_result": [
        "preview delete memory result ",
        "preview remove memory result ",
    ],
    "delete_profile_memory_result": [
