...
from assistant.personality import greet, unknown_response, respond_to_feeling, respond_to_help_request, respond_to_stuck, respond_to_thanks, respond_to_goodbye, respond_to_day_greeting, respond_to_capabilities, respond_to_identity, respond_about_user, explain_response, unknown_chat_response
...
def handle_chat_intent(user_input, analysis):
    ...
    if intent == "chat_feeling_statement":
        ...
        return respond_to_feeling(feeling)
    ...
    if intent == "chat_day_greeting":
        mood = memory.get_profile_value("mood")
        goal = memory.get_profile_value("goal")
        return respond_to_day_greeting(user_input, mood, goal)
    
    if intent == "chat_capabilities":
        return respond_to_capabilities()
    
    if intent == "chat_identity":
        return respond_to_identity()
